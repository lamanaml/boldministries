...
<html lang="en">
  <head>
    ...
    <title>Bread of Life Discipleship Ministries</title>
<!-- 
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="assets/images/header2.png"  alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="assets/images/header3.png" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
        <section class="py-5">
          <div class="container">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="assets/images/leaderschristmas2.JPG" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
        <section class="py-5">
          <div class="container">
...
<!-- Ministries -->
  <section class="py-5">
    <div class="container">
      ...
      <p class="lead">At BOLD Ministries, our mission is to create a deeper understanding of our relationship with GOD.  We invite you to come learn and grow in our walk with Christ.</p>
    </div>
  </section>
